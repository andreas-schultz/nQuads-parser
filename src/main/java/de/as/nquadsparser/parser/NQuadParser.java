...
import de.as.nquadsparser.model.Node;
import de.as.nquadsparser.model.Quad;
import de.as.nquadsparser.util.NTriplesStringConverter;
...
public class NQuadParser extends Parser {
    ...
    // /home/andreas/workspace/ANTLRTester/antlr-files/NQuad.g:112:1: predicate returns [Node value] : iriRef ;
    ...
    // $ANTLR start "graph"
    // /home/andreas/workspace/ANTLRTester/antlr-files/NQuad.g:122:1: graph returns [Node value] : iriRef ;
